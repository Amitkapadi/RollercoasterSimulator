...
public class Back : MonoBehaviour {
	...
	void Update(){
		...
		if (vr == false)
		{
			...
			GameObject.Find("Camera_left").camera.enabled =false ;
		 GameObject.Find("Dive_Camera").transform.rotation=	GameObject.Find("Main Camera").transform.rotation;
			...
			GameObject.Find("Camera_right").camera.enabled =false ;
		} else {
			...
			GameObject.Find("Camera_left").camera.enabled =true ;
			//GameObject.Find("Main Camera").camera.enabled =false ;
			GameObject.Find("Camera_left").tag = "vr";
			GameObject.Find("Camera_right").camera.enabled =true ;
